...
/*---- Class for calculating the volume of various 3D figures ----*/
class VolumeCalculator
{
    ...
    // Method to calculate volume of a hemisphere
    ...
    // Method to perform volume calculation operations for 3D figures
    public static void volumeCalculation()
    {
        ...
        // Using do-while loop to again find the  volume as per user choice 
        do {
            System.out.println("----- ThreeD Figures Volume Calculation --------");
            ...
            // Performing volume calculation based on user's choice
            switch (operation) {
                case 1: 
...
public class ThreeDFiguresOperation {
    public static void main(String[] args) {
        ...
        VolumeCalculator.volumeCalculation();// Calling volumeCalculation() method to Calculate volume 
    }
}
